...
<iframe frameborder='0' height='110' src='http://free.timeanddate.com/clock/i61g6rb5/n73/szw110/szh110/hoc000/hbw2/hfceee/cf100/hncccc/fdi76/mqc000/mql10/mqw4/mqd98/mhc000/mhl10/mhw4/mhd98/mmc000/mml10/mmw1/mmd98/hhv0' width='110'/>
    <b:skin><![CDATA[/*
-----------------------------------------------
...
/* Variable definitions
   ====================
   <Variable name="keycolor" description="Main Color" type="color" default="#539bcd" value="#f4bc4f"/>

   <Group description="Page Text" selector="body">
     <Variable name="body.font" description="Font" type="font"
         default="normal normal 13px 'Trebuchet MS',Trebuchet,sans-serif" value="normal normal 13px Lora"/>
     <Variable name="body.text.color" description="Text Color" type="color" default="#bbbbbb" value="#666666"/>
   </Group>

   <Group description="Backgrounds" selector=".body-fauxcolumns-outer">
     <Variable name="body.background.color" description="Outer Background" type="color" default="#539bcd" value="rgba(0, 0, 0, 0)"/>
   ...
   <Group description="Links" selector=".main-outer">
     <Variable name="link.color" description="Link Color" type="color" default="#ff9900" value="#ff0066"/>
     <Variable name="link.visited.color" description="Visited Color" type="color" default="#b87209" value="#65ff00"/>
     <Variable name="link.hover.color" description="Hover Color" type="color" default="#ff9900" value="#bb4ff4"/>
   </Group>

   <Group description="Blog Title" selector=".header h1">
     <Variable name="header.font" description="Font" type="font"
         default="normal normal 60px 'Trebuchet MS',Trebuchet,sans-serif" value="normal bold 80px Calligraffitti"/>
     <Variable name="header.text.color" description="Text Color" type="color" default="#ffffff"  value="#f44f87"/>
   </Group>

   <Group description="Blog Description" selector=".header .description">
     <Variable name="description.text.color" description="Description Color" type="color"
         default="$(body.text.color)"  value="#f44f87"/>
   </Group>

   <Group description="Tabs Text" selector=".tabs-inner .widget li a">
     <Variable name="tabs.font" description="Font" type="font"
         default="normal bold 16px 'Trebuchet MS',Trebuchet,sans-serif" value="normal bold 16px Covered By Your Grace"/>
   ...
   <Group description="Date Header" selector=".main-inner h2.date-header">
     <Variable name="date.font" description="Font" type="font"
         default="normal normal 14px 'Trebuchet MS',Trebuchet,sans-serif" value="normal normal 14px Calligraffitti"/>
     <Variable name="date.text.color" description="Text Color" type="color" default="$(body.text.color)" value="#5d277a"/>
   </Group>

   <Group description="Post Title" selector="h3.post-title a">
     <Variable name="post.title.font" description="Font" type="font"
         default="normal bold 20px 'Trebuchet MS',Trebuchet,sans-serif" value="normal bold 20px Paytone One"/>
   ...
   <Group description="Post Background" selector=".column-center-inner">
     <Variable name="post.background.color" description="Background Color" type="color"
         default="transparent" value="#cfe2f3"/>
     <Variable name="post.background.url" description="Post Background URL" type="url" default="none" value="none"/>
   </Group>

   <Group description="Gadget Title Color" selector="h2">
     <Variable name="widget.title.font" description="Font" type="font"
        default="normal bold 14px 'Trebuchet MS',Trebuchet,sans-serif" value="normal bold 14px Fontdiner Swanky"/>
   ...
   <Group description="Gadget Text" selector=".footer-inner .widget, .sidebar .widget">
     <Variable name="widget.font" description="Font" type="font"
        default="$(body.font)" value="normal normal 13px Josefin Slab"/>
     <Variable name="widget.text.color" description="Text Color" type="color" default="$(body.text.color)" value="rgba(0, 0, 0, 0)"/>
   </Group>

   <Group description="Gadget Links" selector=".sidebar .widget">
     <Variable name="widget.link.color" description="Link Color" type="color" default="$(body.text.color)" value="#64ff00"/>
     <Variable name="widget.link.visited.color" description="Visited Color" type="color" default="$(link.visited.color)" value="#9800ff"/>
     <Variable name="widget.alternate.text.color" description="Alternate Color" type="color" default="#ffffff" value="#4ff4bc"/>
   </Group>
   ...
   <Variable name="body.background" description="Body Background" type="background"
       color="$(body.background.color)" default="$(color) none repeat-x scroll top center" value="#f4bc4f url(//themes.googleusercontent.com/image?id=0BwVBOzw_-hbMMDYxYTU0MmQtZTA5Yi00MTIwLTk3ZjktZWI4MzJhMDQyOTIy) repeat fixed top center"/>
   ...
   <Variable name="mobile.button.color" description="Mobile Button Color" type="color" default="#ffffff"  value="#ff0000"/>
      ...
      gapi.load(&quot;gapi.iframes:gapi.iframes.style.bubble&quot;, function() {
        if (gapi.iframes &amp;&amp; gapi.iframes.getContext) {
          gapi.iframes.getContext().openChild({
              url: &#39;https://draft.blogger.com/navbar.g?targetBlogID\x3d1467680186386028071\x26blogName\x3dSimanto+Mondal\x26publishMode\x3dPUBLISH_MODE_BLOGSPOT\x26navbarType\x3dLIGHT\x26layoutType\x3dLAYOUTS\x26searchRoot\x3dhttps://simantomondal.blogspot.com/search\x26blogLocale\x3den\x26v\x3d2\x26homepageUrl\x3dhttps://simantomondal.blogspot.com/\x26vt\x3d3974893874405175716&#39;,
  ...
  <div class='content-inner'>
    ...
    <div class='region-inner header-inner'>
      <b:section class='header' id='header' maxwidgets='1' name='Header' showaddelement='no'>
        <b:widget id='Header1' locked='true' title='Simanto Mondal (Header)' type='Header'>
          <b:widget-settings>
            <b:widget-setting name='displayUrl'>http://3.bp.blogspot.com/-o3nUgONxgug/WkE1WXOynfI/AAAAAAAAAAQ/ZbE7rd6BPho7ExSRvM4c6_m3QMAbUSXnQCK4BGAYYCw/s1600/23843104_172690029982202_2416044346092337581_n.jpg</b:widget-setting>
            <b:widget-setting name='displayHeight'>854</b:widget-setting>
            <b:widget-setting name='sectionWidth'>471</b:widget-setting>
          ...
          <b:section class='main' id='main' name='Main' showaddelement='no'>
            <b:widget id='Blog1' locked='true' title='Blog Posts' type='Blog'>
              <b:widget-settings>
                ...
                <b:widget-setting name='style.urlcolor'>#5d277a</b:widget-setting>
                <b:widget-setting name='showAuthor'>false</b:widget-setting>
                <b:widget-setting name='style.linkcolor'>#000000</b:widget-setting>
                <b:widget-setting name='style.unittype'>TextAndImage</b:widget-setting>
                <b:widget-setting name='style.bgcolor'>#cfe2f3</b:widget-setting>
                ...
                <b:widget-setting name='style.bordercolor'>#cfe2f3</b:widget-setting>
    ...
    <div class='region-inner footer-inner'>
      ...
      <b:section class='foot' id='footer-3' name='Footer' showaddelement='no'>
        <b:widget id='Attribution1' locked='true' title='' type='Attribution'>
          <b:widget-settings>
            <b:widget-setting name='copyright'>Simanto Mondal</b:widget-setting>
          </b:widget-settings>
          <b:includable id='main'>
...
<b:section-contents id='sidebar-left-1'>
...
</b:section-contents><b:section-contents id='sidebar-left-2-1'>
  <b:widget id='ReportAbuse1' locked='false' title='' type='ReportAbuse'>
    <b:includable id='main'>
  <b:include name='reportAbuse'/>
</b:includable>
  </b:widget>
</b:section-contents><b:section-contents id='sidebar-left-2-2'>
...
</b:section-contents><b:section-contents id='sidebar-left-3'>
  ...
  <b:widget id='PageList1' locked='false' title='Pages' type='PageList'>
    <b:widget-settings>
      <b:widget-setting name='pageListJson'><![CDATA[{'home': {'href': 'https://simantomondal.blogspot.com/', 'title': 'হোম', 'position': 0}}]]></b:widget-setting>
      <b:widget-setting name='homeTitle'>হ&#2507;ম</b:widget-setting>
    </b:widget-settings>
    <b:includable id='main'>
  <b:if cond='data:title != &quot;&quot;'><h2><data:title/></h2></b:if>
  <div class='widget-content'>
  ...
  <b:widget id='Gadget3' locked='false' title='Today&apos;s News' type='Gadget'>
    <b:includable id='main'>
  <!-- only display title if it's non-empty -->
  ...
  <b:widget id='Translate1' locked='false' title='Translate Site' type='Translate'>
    <b:widget-settings>
  ...
  <b:widget id='BloggerButton1' locked='false' title='' type='BloggerButton'>
    <b:widget-settings>
      <b:widget-setting name='button'>https://img1.blogblog.com/html/buttons/blogger-powerby-blue.gif</b:widget-setting>
    </b:widget-settings>
    <b:includable id='main'>
 <div class='widget-content'>
  ...
  <b:widget id='Gadget2' locked='false' title='Song' type='Gadget'>
    <b:includable id='main'>
  <!-- only display title if it's non-empty -->
  <b:if cond='data:renderingUrl != &quot;&quot;'>
    <b:if cond='data:title != &quot;&quot;'>
  ...
  <b:widget id='Gadget1' locked='false' title='HAPPY NEW YEAR' type='Gadget'>
    <b:includable id='main'>
  <!-- only display title if it's non-empty -->
  <b:if cond='data:renderingUrl != &quot;&quot;'>
    <b:if cond='data:title != &quot;&quot;'>
  ...
  <b:widget id='Poll1' locked='false' title='How is site&apos;s status?' type='Poll'>
    <b:widget-settings>
      <b:widget-setting name='enddate'>12/31/17</b:widget-setting>
      <b:widget-setting name='answer-0'>awesome </b:widget-setting>
      <b:widget-setting name='endtime'>11:59 PM</b:widget-setting>
      <b:widget-setting name='answer-2'>usefull</b:widget-setting>
      <b:widget-setting name='allowmultiple'>true</b:widget-setting>
      <b:widget-setting name='answer-1'>nice</b:widget-setting>
      <b:widget-setting name='answer-3'>kindly </b:widget-setting>
    </b:widget-settings>
    <b:includable id='main'>
  <!-- only display title if it's non-empty -->
  <b:if cond='data:title != &quot;&quot;'>
 ...
 <div class='widget-content'>
  ...
  <b:widget id='Followers1' locked='false' title='Followers' type='Followers'>
    <b:widget-settings>
      ...
      <b:widget-setting name='contentSecondaryTextColor'>#4ff4bc</b:widget-setting>
      <b:widget-setting name='contentHeadlineColor'>#ffffff</b:widget-setting>
      ...
      <b:widget-setting name='contentSecondaryLinkColor'>#ff0066</b:widget-setting>
      <b:widget-setting name='endcapLinkColor'>#ff0066</b:widget-setting>
      <b:widget-setting name='contentLinkColor'>#ff0066</b:widget-setting>
    </b:widget-settings>
    <b:includable id='main'>
  ...
  <b:widget id='Feed1' locked='false' title='' type='Feed'>
    <b:widget-settings>
      <b:widget-setting name='feedUrl'>https://trickbd.com/feed</b:widget-setting>
  ...
  <b:widget id='BlogArchive2' locked='false' title='New' type='BlogArchive'>
    <b:widget-settings>
  ...
  <b:widget id='HTML1' locked='false' title='' type='HTML'>
    <b:widget-settings>
      <b:widget-setting name='content'><![CDATA[<iframe src="http://free.timeanddate.com/clock/i61g6rb5/n73/szw110/szh110/hoc000/hbw2/hfceee/cf100/hncccc/fdi76/mqc000/mql10/mqw4/mqd98/mhc000/mhl10/mhw4/mhd98/mmc000/mml10/mmw1/mmd98/hhv0" frameborder="0" width="110" height="110"></iframe>]]></b:widget-setting>
    </b:widget-settings>
    <b:includable id='main'>
  <!-- only display title if it's non-empty -->
  <b:if cond='data:title != &quot;&quot;'>
  ...
  <b:widget id='BlogSearch2' locked='false' title='Search Something' type='BlogSearch'>
    <b:includable id='main'>
    <!-- only display title if it's non-empty -->
    <b:if cond='data:title != &quot;&quot;'>
      <h2 class='title'><data:title/></h2>
